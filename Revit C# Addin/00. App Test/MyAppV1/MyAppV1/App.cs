...
namespace MyAppV1
{
    class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication uiConApp)
        {
            ...
            SplitButton sb = other_Panel.AddItem(sb1) as SplitButton;
            sb.AddPushButton(increaseParaForm_Button_Data_01);
            sb.AddPushButton(showElementForm_Button_Data_01);
            sb.AddPushButton(selectElementByParaValueForm_Button_Data_01);
